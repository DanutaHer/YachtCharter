        ...
        if (scanner.hasNext()) {
            switch (scanner.next()) {
                case "1":
                    ...
                    CustomerService addCustomerService = new CustomerService();
                ...
                case "3":
                    ...
                    CustomerService editCustomerService = new CustomerService();
                    editCustomerService.editCustomer();
                    printMenu();
                    break;
                case "4":
                    System.out.println("Will remove a customer");
                    CustomerService deleteCustomerService = new CustomerService();
                    deleteCustomerService.deleteCustomer();
                    printMenu();
                    break;
                case "0":
        ...
        if (scanner.hasNext()) {
            switch (scanner.next()) {
                case "1":
                    ...
                    RentService addRentService = new RentService();
                    addRentService.addRent();
                    printMenu();
                    break;
                case "2":
                    System.out.println("Will find a reservation");
                    RentService findRentService = new RentService();
                    findRentService.getRent();
                    printMenu();
                    break;
                case "3":
                ...
                case "4":
                    ...
                    RentService cancelRentService = new RentService();
                    cancelRentService.deleteRent();
                    printMenu();
                    break;
                case "0":
                    System.out.println("Going back");
